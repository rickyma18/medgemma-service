...
def test_chunking_short_transcript():
    ...
    chunks = chunk_transcript(t, max_duration_ms=5000, soft_duration_limit_ms=None)
...
def test_chunking_long_transcript():
    ...
    # Run chunking with 5 min limit (300,000 ms), disable soft limit for legacy behavior
    chunks = chunk_transcript(t, max_duration_ms=300000, soft_duration_limit_ms=None)
...
def test_chunking_boundary_edge_case():
    ...
    chunks = chunk_transcript(t, max_duration_ms=2000, soft_duration_limit_ms=None)
